...
(function ($) {
	...
	InitPreloader = function () {
		//http://gifmake.com/
		_self.append("<div class='pv-loading'><div class='pv-image-loading'></div></div>");

		var pvWrapper = $(".pv-wrapper");
		var w = pvWrapper.width();
		var h = pvWrapper.height();
		if (h == 0) h = $(window).height();

		$('.pv-loading').css('left', (w / 2) - 50 + 'px');
		$('.pv-loading').css('top' , (h / 2) - 33 + 'px');
	};
