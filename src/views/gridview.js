...
PivotViewer.Views.GridView = PivotViewer.Views.TileBasedView.subClass({
	...
	GetButtonImage: function () {
		return PivotViewer.Utils.ImageUrl(baseUrl + "Content/css/pivotviewer/images/GridView.png");
	},
	GetButtonImageSelected: function () {
		return PivotViewer.Utils.ImageUrl(baseUrl + "Content/css/pivotviewer/images/GridViewSelected.png");
	},
