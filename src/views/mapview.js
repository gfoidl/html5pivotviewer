...
PivotViewer.Views.MapView = PivotViewer.Views.IPivotViewerView.subClass({
	...
	GetButtonImage: function () {
		return PivotViewer.Utils.ImageUrl(baseUrl + "Content/css/pivotviewer/images/MapView.png");
	},
	GetButtonImageSelected: function () {
		return PivotViewer.Utils.ImageUrl(baseUrl + "Content/css/pivotviewer/images/MapViewSelected.png");
	},
