...
PivotViewer.Views.GraphView = PivotViewer.Views.TileBasedView.subClass({
	...
	GetButtonImage: function () {
		return PivotViewer.Utils.ImageUrl(baseUrl + "Content/css/pivotviewer/images/GraphView.png");
	},
	GetButtonImageSelected: function () {
		return PivotViewer.Utils.ImageUrl(baseUrl + "Content/css/pivotviewer/images/GraphViewSelected.png");
	},
